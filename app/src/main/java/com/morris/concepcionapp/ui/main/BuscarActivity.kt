    ...
    private fun buscar(busqueda: String, tipoBusqueda: String): List<Negocio> {
        ...
        return listOf(
            Negocio("Tenttacione", "Todo el dia", "+5493442508072", "3442675657",
                "Pizzas y empanadas", "Rocamora 409",
